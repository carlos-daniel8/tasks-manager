    ...
    <div className="task-container">
      <header>
        ...
        <Link to="/tasks/profile">
          <button className="my-profile-button">Meu perfil</button>
        </Link>
              ...
              {editingTaskId === task.id ? (
                <div>
                  ...
                  <input
                    ...
                    onChange={handleEditInputChange}
                  />
                  <button className="confirm-edit-button" onClick={updateTask}>
                    Salvar
                  </button>
                ...
                <div>
                  ...
                  >
                    <strong>Objetivo:</strong> {task.goal}
                  </p>
                  <p
                    style={{
                      textDecoration: task.isCompleted ? "line-through" : "",
                  ...
                  >
                    <strong>Tempo Previsto:</strong> {task.estimatedDays} dias
                  </p>
                  <p
                    style={{
                      textDecoration: task.isCompleted ? "line-through" : "",
